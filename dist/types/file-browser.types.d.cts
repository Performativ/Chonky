...
import { ChonkyActions } from '../action-definitions/index.cjs';
import { b as FileAction, G as GenericFileActionHandler } from '../action-handler.types-swQLT4E1.cjs';
import { FileArray } from './file.types.cjs';
import { I18nConfig } from './i18n.types.cjs';
import { ChonkyIconProps } from './icons.types.cjs';
import { ThumbnailGenerator } from './thumbnails.types.cjs';
import './action-payloads.types.cjs';
import './file-view.types.cjs';
import '../util/file-helper.cjs';
...
type ChonkyActionUnion = (typeof ChonkyActions)[keyof typeof ChonkyActions];
/**
...
export type { ChonkyActionUnion, FileBrowserHandle, FileBrowserProps };
