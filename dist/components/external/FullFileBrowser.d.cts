...
import { FileBrowserProps, FileBrowserHandle } from '../../types/file-browser.types.cjs';
...
declare const FullFileBrowser: React__default.NamedExoticComponent<FileBrowserProps & React__default.RefAttributes<FileBrowserHandle>>;

export { FullFileBrowser };
