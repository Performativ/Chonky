...
const ChonkyIconContext = createContext(ChonkyIconPlaceholder);
...
const ChonkyIconFA = ({ icon, className, style }) => {
  const Icon = IconMap[icon] || ChonkyIconPlaceholder;
  const classes = useStyles();
  return /* @__PURE__ */ jsx(Icon, { size: 16, className: cn(classes.icon, className), style });
};
export {
  AudioExtensions,
  ChonkyIconContext,
