...
import { FileBrowserHandle } from '../types/file-browser.types.cjs';
...
declare const useFileBrowserHandle: (ref: React__default.Ref<FileBrowserHandle>) => void;

export { useFileBrowserHandle };
